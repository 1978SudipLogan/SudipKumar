...
export default function About() {
    return (
        <div className='grid sm:grid-cols-3 dark:bg-slate-800 sm:h-screen' id="about">
            <div className='border-2 border-sky-500 sm:mx-auto shadow-lg sm:max-w-96 text-center m-4   sm:m-4 p-2   sm:w-full bg-[#5eead4]'>
            ...
            <div className='border-2 border-sky-500 sm:mx-auto shadow-lg sm:max-w-96 text-center m-4  sm:m-4 p-2   sm:w-full bg-#f9a8d4-200 bg-[#5eead4]'>
